...
public class NatureDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder mb)
    {
        ...
        mb.Entity<Photo>().HasData(
          ...
          new Photo { Id=2, PlaceId=2, Url="https://cloudfront-us-east-1.images.arcpublishing.com/infobae/6VJHMRXIY5HKDGJ775PGPVH65Q.jpg"},
          new Photo { Id=3, PlaceId=3, Url="https://www.caminoreal.com/storage/app/media/Blog/la-bufadora-baja-california.jpg"}
        );
